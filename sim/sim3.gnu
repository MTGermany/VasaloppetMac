...
##############################################################
set out "sim3_traj.eps"; print "plotting sim3_traj.eps"
##############################################################
...
plot\
  "sim3.traj" u ($1):(0.001*filterRange($2,xmin,xmax)) t "n=100" w l ls 1,\
  "sim3.traj" u ($1):(0.001*filterRange($3,xmin,xmax)) t "n=500" w l ls 2,\
  "sim3.traj" u ($1):(0.001*filterRange($4,xmin,xmax)) t "n=1500" w l ls 3,\
  "sim3.traj" u ($1):(0.001*filterRange($5,xmin,xmax)) t "n=2500" w l ls 4,\
  "sim3.traj" u ($1):(0.001*filterRange($6,xmin,xmax)) t "n=4000" w l ls 5,\
  "sim3.traj" u ($1):(0.001*filterRange($7,xmin,xmax)) t "n=6000" w l ls 6,\
  "sim3.traj" u ($1):(0.001*filterRange($8,xmin,xmax)) t "n=8000" w l ls 7,\
  "sim3.traj" u ($1):(0.001*filterRange($9,xmin,xmax)) t"n=10000" w l ls 8,\
  "sim3.traj" u ($1):(0.001*filterRange($10,xmin,xmax))t"n=12000" w l ls 1,\
  "sim3.traj" u ($1):(0.001*filterRange($11,xmin,xmax))t"n=15000" w l ls 2

##############################################################
set out "sim3_HoegstaPunkten.eps"; print "plotting sim3_HoegstaPunkten.eps"
##############################################################
...
set auto y
plot\
  "sim3.HoegstaPunktenCalib" u 1:3 t "Data" w l ls 17,\
  "sim3.x2980" u 1:2 t "Simulation" w l ls 16

##############################################################
set out "sim3_HoegstaPunkten_ncum.eps"; print "plotting sim3_HoegstaPunkten_ncum.eps"
##############################################################
...
set auto y
plot\
  "sim3.HoegstaPunktenCalib" u 1:4 t "Data" w l ls 17,\
  "sim3.x2980" u 1:4 t "Simulation" w l ls 16
...
##############################################################
set out "sim3_rho.eps"; print "plotting sim3_rho.eps"
##############################################################
...
splot  "sim3.macro" u ($1):(0.001*$2):($3) t ""  w l ls 99
